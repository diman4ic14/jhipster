    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="jHipsterApp.category.home.createOrEditLabel" v-text="$t('jHipsterApp.category.home.createOrEditLabel')">Create or edit a Category</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jHipsterApp.category.name')" for="category-name">Name</label>
