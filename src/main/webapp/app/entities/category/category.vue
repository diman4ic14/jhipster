<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('jHipsterApp.category.home.title')" id="category-heading">Categories</span>
            <router-link :to="{name: 'CategoryCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-category">
                ...
                <span  v-text="$t('jHipsterApp.category.home.createLabel')">
        ...
        <div class="alert alert-warning" v-if="!isFetching && categories && categories.length === 0">
            <span v-text="$t('jHipsterApp.category.home.notFound')">No categories found</span>
        </div>
        <div class="table-responsive" v-if="categories && categories.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('jHipsterApp.category.name')">Name</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="jHipsterApp.category.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-category-heading" v-text="$t('jHipsterApp.category.delete.question', {'id': removeId})">Are you sure you want to delete this Category?</p>
            </div>
